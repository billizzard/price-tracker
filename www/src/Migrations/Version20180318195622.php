 ...
 */
class Version20180318195622 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE host (id INT AUTO_INCREMENT NOT NULL, host VARCHAR(255) NOT NULL, parser VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_CF2713FDCF2713FD (host), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
